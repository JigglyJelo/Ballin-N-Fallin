...
public partial class Level : Node2D {
	...
	public override void _Ready(){
		...
		SetupBackground();
		List<StaticBody2D> staticBodies = GatherStaticBodies();
		ConvertPathsToPolygons(staticBodies);
		List<CollisionPolygon2D>[] collisions = ExtractAndCenterCollisions(staticBodies);
		MergeInvertedPolygons(collisions);
		GenerateLevelVisuals(collisions,staticBodies);
	...
	private void CheckForColorOverrides(){
		//Check if Colors are overridden
	...
	private List<StaticBody2D> GatherStaticBodies(){
	...
	private void ConvertPathsToPolygons(List<StaticBody2D> staticBodies){
	...
	private List<CollisionPolygon2D>[] ExtractAndCenterCollisions(List<StaticBody2D> staticBodies){
	...
	private void GenerateLevelVisuals(List<CollisionPolygon2D>[] collisions, List<StaticBody2D> staticBodies){
