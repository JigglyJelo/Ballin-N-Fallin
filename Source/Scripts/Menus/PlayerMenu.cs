...
public partial class PlayerMenu : Node2D{
	...
	private readonly PackedScene PLAYER_SETTINGS_MENU_SCENE = GD.Load<PackedScene>("res://Source/Scenes/Menus/PlayerSettingsMenu/PlayerSettingsMenu.tscn");
	...
	public override void _Process(double delta){
		...
		if(Game.TotalPlayers == 0 && Input.IsActionJustPressed("Charge N Launch Mouse")){
			...
			Game.TotalPlayers++;
			PlayerSettingsMenu newMenu = PLAYER_SETTINGS_MENU_SCENE.Instantiate<PlayerSettingsMenu>();
			//Game.InputIds.Add(1);
