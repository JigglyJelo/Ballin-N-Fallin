...
![Cover Image](Assets/Sprites/Player/Player.png)

*A physics-based multiplayer party game currently in development.*
...
* **Creative Assets:** Most of the creative assets (located in the `Assets` folder) are either in the **Public Domain** or are available under Creative Commons licenses, specifically **CC0**, **CC BY**, or **CC BY-SA**. 
...
* **Third-Party Assets:** Specific media elements, such as fonts, audio, and certain images, are utilized under their respective licenses (CC BY, CC0, OFL, etc). For exact terms and conditions, please refer to the `ATTRIBUTIONS.txt` file or the local credit files within the individual asset folders.

---

### Brand & Trademark Disclaimer

> **All Rights Reserved:** Please note that the "Ballin N Fallin" name, logo, branding, and associated brand assets are proprietary and strictly All Rights Reserved.